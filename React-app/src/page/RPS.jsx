...
export const RPS = () => {
  ...
  function playGame(playerMove) {
    ...
    document.getElementById("js-move").innerHTML = `You ${
      playerMove || "Chose"
        ...
        <div className="w-full h-full flex justify-center bg-black/30 backdrop-blur-[5px]">
          <div className=" mt-5 w-fit h-fit p-10 bg-black/50 backdrop-blur-[5px] space-y-4 rounded-2xl">
            ...
            <div className="px-4 pt-6 flex justify-center space-x-6">
              <button
                className="w-fit h-7 py-6 px-4 flex-center text-2xl text-black font-bold bg-white/50 brightness-100 rounded-[10px]"
                onClick={() => removeScore()}
              >
                Remove Score
              </button>
